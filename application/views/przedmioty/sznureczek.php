...
<div class="col-md-5">
    ...
    <div style="position: relative; height: 520px">
        ...
        <button onclick="wyczysc('div1')" id="div1delsz" class="buttondel" style="display: none"><span
                class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <div id="div1" class="column sz1" draggable="true"
             ondragenter="event.stopPropagation(); event.preventDefault();"
             ondragover="event.stopPropagation(); event.preventDefault();"
             ondrop="event.stopPropagation(); event.preventDefault();">
        </div>
        <button onclick="wyczysc('div2')" id="div2delsz" class="buttondel" style="display: none"><span
                class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <div id="div2" class="column sz2" draggable="true"
             ondragenter="event.stopPropagation(); event.preventDefault();"
             ondragover="event.stopPropagation(); event.preventDefault();"
             ondrop="event.stopPropagation(); event.preventDefault();">
        </div>
        <button onclick="wyczysc('div3')" id="div3delsz" class="buttondel" style="display: none"><span
                class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <div id="div3" class="column sz3" draggable="true"
             ondragenter="event.stopPropagation(); event.preventDefault();"
             ondragover="event.stopPropagation(); event.preventDefault();"
             ondrop="event.stopPropagation(); event.preventDefault();">
        </div>
    ...
    <div class="row" style="margin-top: -60px;">
        <div class="center-block container-fluid">
            ...
            foreach ($sznureczki as $key) {
                ...
                ?>
                <img draggable="false"
                     src="<?= base_url() ?>assetss/img/products/bransoletki/sznureczek/thumbs/<?= $zdjecie ?>"
                     onclick="zmien('<?= $key->nazwa_zdjecia ?>')" style="cursor: pointer"/>
                <?php
            }
            ?>
        </div>
...
<div class="col-md-4 col-md-offset-1 right-menu">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <p class="cena-przedmiotu" id="cena1"><span id="cena"><?= number_format($key->zawieszka1, 2) ?> zł</span>
            </p>
            <p class="cena-przedmiotu" id="cena2" style="display: none;"><span
                    id="cena"><?= number_format($key->zawieszka2, 2) ?> zł</span></p>
            <p class="cena-przedmiotu" id="cena3" style="display: none"><span
